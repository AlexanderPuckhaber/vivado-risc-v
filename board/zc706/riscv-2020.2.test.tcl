...
proc create_DDR_before_mig { parentCell nameHier } {
  variable script_folder
...
proc create_DDR_after_mig { parentCell nameHier } {
...
proc create_root_design { parentCell } {
  ...
  create_DDR_before_mig [current_bd_instance .] DDR
  # what is current_bd_instance now? (/)

  ### RUN MIG MANUALLY

  create_DDR_after_mig [current_bd_instance .] DDR

  # current_bd_instance still (/) ???
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKIN2_PERIOD {20.0} \
